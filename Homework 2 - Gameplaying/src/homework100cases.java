...
public class homework100cases {
	...
	public static void main(String [] args) throws IOException {
		...
		for(nthInput = 0; nthInput<=99; nthInput++) {
			List<String> lines = Files.readAllLines(Paths.get("Test cases/testcases-100/INPUT", Integer.toString(nthInput)+".in"));
			...
			//create output file
			PrintWriter writer = new PrintWriter("Test cases/Output for 100 cases/"+Integer.toString(nthInput)+".out", "UTF-8");
			...
			writer.close();
			Path file1 = Paths.get("Test cases/Output for 100 cases/", Integer.toString(nthInput)+".out");
			Path file2 = Paths.get("Test cases/testcases-100/OUTPUT/", Integer.toString(nthInput)+".out");
